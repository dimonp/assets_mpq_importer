...
static inline auto pack_cliff_key(uint8_t la0, uint8_t la1, uint8_t la2, uint8_t la3, uint8_t var) -> uint32_t
{
    return static_cast<uint32_t>(la0 & 0b11) | static_cast<uint32_t>((la1 & 0b11) << 2)
           | static_cast<uint32_t>((la2 & 0b11) << 4) | static_cast<uint32_t>((la3 & 0b11) << 6)
           | static_cast<uint32_t>((var & 0b11) << 8);
}

static inline auto unpack_cliff_key(uint32_t key) -> CliffKey
{
    return { .la0 = static_cast<uint8_t>(key & 0b11),
...
static inline auto pack_ramp_key(uint8_t la0, uint8_t la1, uint8_t la2, uint8_t la3, uint8_t var, uint8_t par)
  -> uint32_t
{
    return static_cast<uint32_t>(la0 & 0b1111) | static_cast<uint32_t>((la1 & 0b1111) << 4)
           | static_cast<uint32_t>((la2 & 0b1111) << 8) | static_cast<uint32_t>((la3 & 0b1111) << 12)
           | static_cast<uint32_t>((var & 0b1111) << 16) | static_cast<uint32_t>((par & 0b1111) << 20);
}

static inline auto unpack_ramp_key(uint32_t key) -> RampKey
{
    return { .la0 = static_cast<uint8_t>(key & 0b1111),
...
static inline auto decode_geo_char(char char_code) -> uint8_t
{
...
static inline auto encode_geo_char(uint8_t code) -> char
{
...
auto get_cliff_key_from_geo_name(const std::string &str_key) -> uint32_t
{
    ...
    return pack_cliff_key(decode_geo_char(static_cast<char>(str_key[3])),
...
{
    Ensures(str_key.length() >= 5);
    return pack_ramp_key(decode_geo_char(static_cast<char>(str_key[3])),
      decode_geo_char(static_cast<char>(str_key[2])),
      decode_geo_char(static_cast<char>(str_key[1])),
      decode_geo_char(static_cast<char>(str_key[0])),
      decode_geo_char(static_cast<char>(str_key[4])),
