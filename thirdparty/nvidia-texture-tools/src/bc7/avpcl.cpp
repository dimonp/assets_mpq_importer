...
std::atomic<bool> AVPCL::flag_premult {false};
std::atomic<bool> AVPCL::flag_nonuniform {false};
std::atomic<bool> AVPCL::flag_nonuniform_ati {false};

// global mode
//bool AVPCL::mode_rgb = false;		// true if image had constant alpha = 255
std::atomic<bool> AVPCL::mode_rgb {false};
