...
class HashData : public boost::operators<HashData>
{
	public:
		...
		HashData(const std::filesystem::path &path, File::Locale locale = File::Locale::Neutral, File::Platform platform = File::Platform::Default);
		...
		bool isHash(const std::filesystem::path &path, File::Locale locale = File::Locale::Neutral, File::Platform platform = File::Platform::Default) const;
...
inline bool HashData::operator==(const std::filesystem::path &path) const
{
