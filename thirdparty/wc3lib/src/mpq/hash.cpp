...
HashData::HashData(const std::filesystem::path& path, File::Locale locale, File::Platform platform) : m_filePathHashA(HashString(Archive::cryptTable(), path.string().c_str(), HashType::NameA)), m_filePathHashB(HashString(Archive::cryptTable(), path.string().c_str(), HashType::NameB)), m_locale(File::localeToInt(locale)), m_platform(File::platformToInt(platform))
{
}
...
bool HashData::isHash(const std::filesystem::path &path, File::Locale locale, File::Platform platform) const
{
...
/*
bool Hash::isHash(const std::filesystem::path &path, enum File::Locale locale, enum File::Platform platform) const
{
...
void Hash::changePath(const std::filesystem::path &path)
{
