...
{
	public:
		typedef std::vector<std::unique_ptr<TriggerFunctionParameter>> Parameters;
		...
		TriggerFunction();
        TriggerFunction(const TriggerFunction &triggerFunction) = delete;
        TriggerFunction& operator=(const TriggerFunction &triggerFunction) = delete;
