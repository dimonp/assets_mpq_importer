			...
			public:
				...
				class Color
				{
					...
					protected:
						 ...
						 */
						typedef std::optional<byte> Alpha;
						/**
...
{
	return this->m_value.which() == 1 && boost::get<IndexAndAlpha>(m_value).second.has_value();
}
...
{
	return boost::get<IndexAndAlpha>(m_value).second.value();
}
