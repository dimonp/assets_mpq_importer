...
inline MdxChunkHeader readMdxHeader(Format::InputStream &istream, std::streamsize &sizeCounter, const char8_t *expectedTag)
{
	MdxChunkHeader header;
...
inline MdxChunkHeader writeMdxHeader(Format::OutputStream &ostream, std::streamsize &sizeCounter, const char8_t *expectedTag, uint32 headerSize)
{
	MdxChunkHeader header;
...
inline void skipMdxInclusiveEmptyBytes(Format::InputStream &istream, const long32 &inclusiveSize, std::streamsize &size)
{
...
inline void skipMdxHeaderEmptyBytes(Format::InputStream &istream, const MdxChunkHeader &header, const std::streamsize &size)
{
...
inline Format::OutputStream::pos_type skipMdxHeader(Format::OutputStream &ostream)
{
	...
	ostream.seekp(sizeof(MdxChunkHeader), std::ios_base::cur);
