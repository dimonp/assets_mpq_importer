 ...
 */
TEST_CASE("ExtractOrcUpgradeStrings", "[extract]")
{
	/*
	...
	const std::filesystem::path war3Path = wc3DirPath / "War3xLocal.mpq";
	...
	const  std::filesystem::path target = workingDir / "War3xLocal.mpq";
